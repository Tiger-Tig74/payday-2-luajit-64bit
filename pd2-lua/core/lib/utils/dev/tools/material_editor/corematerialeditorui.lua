...
function CoreMaterialEditor:_create_main_frame()
	...
	self._output_text_ctrl = CoreEWS:XMLTextCtrl(self._material_output_collapse_box:lower_panel(), nil, , , "TE_MULTILINE,TE_RICH2,TE_DONTWRAP,TE_READONLY")
	...
	self._global_text_ctrl = CoreEWS:XMLTextCtrl(self._global_output_collapse_box:lower_panel(), nil, , , "TE_MULTILINE,TE_RICH2,TE_DONTWRAP,TE_READONLY")
