...
function CoreEditor:create_projection_light(type)
	...
	managers.viewport:set_default_environment("core/environments/default_depthlight", nil, )
...
function CoreEditor:cube_map_done()
	...
	if self._cubemap_params.saved_environment then
		managers.viewport:set_default_environment(self._cubemap_params.saved_environment, nil, )
	end
