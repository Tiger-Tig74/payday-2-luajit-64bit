...
function EnvironmentHandler:init(env_manager, is_first_viewport)
	...
	self:set_environment(self._env_manager:default_environment(), nil, , , )
end
...
function EnvironmentHandler:on_default_environment_changed(default_environment_path, blend_duration, blend_bezier_curve)
	if not self._current_area then
		self:set_environment(default_environment_path, blend_duration, blend_bezier_curve, nil, )
	end
end
...
function EnvironmentHandler:on_override_environment_changed(override_environment_path, blend_duration, blend_bezier_curve)
	...
	self:set_environment(self._override_environment or self._path, blend_duration, blend_bezier_curve, nil, )
end
...
function EnvironmentHandler:_leave_current_area()
	self:set_environment(self._env_manager:default_environment(), self._current_area:transition_time(), self._current_area:bezier_curve(), nil, )
