...
require("lib/managers/InfamyManagerNew")
...
require("lib/units/props/InfamyCardGui")
require("lib/units/props/WeaponFiremodeGui")
...
require("lib/managers/SideJobEventManager")
...
function Setup:init_managers(managers)
	...
	managers.belt = MachineGunBeltManager:new()
