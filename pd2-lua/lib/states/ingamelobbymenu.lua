...
function IngameLobbyMenuState:init(game_state_machine)
	...
	if managers.hud then
		...
		managers.hud:load_hud_menu(self.GUI_LOOTSCREEN, false, true, false, {}, nil, , true)
...
function IngameLobbyMenuState:load_loothud_skirmish(should_show)
	if not self._setup then
		...
		managers.hud:load_hud(self.GUI_LOOTSCREEN_SKIRMISH, false, true, false, {}, nil, , true)
	end
...
function IngameLobbyMenuState:load_loothud(should_show)
	...
	if not self._setup then
		...
		managers.hud:load_hud(gui_lootscreen, false, true, false, {}, nil, , true)
	end
