function LootDropTweakData:init_generated(tweak_data)
	...
	self.global_values.auc = {
		name_id = "bm_global_value_auc",
		desc_id = "menu_l_global_value_auc",
		unlock_id = "bm_global_value_auc_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = false,
		hide_unavailable = false,
	...
	self.global_values.corp = {
		name_id = "bm_global_value_corp",
		desc_id = "menu_l_global_value_corp",
		unlock_id = "bm_global_value_corp_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = false,
		hide_unavailable = false,
	...
	self.global_values.cot = {
		name_id = "bm_global_value_cot",
		desc_id = "menu_l_global_value_cot",
		unlock_id = "bm_global_value_cot_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = false,
	...
	self.global_values.pxp3 = {
		name_id = "bm_global_value_pxp3",
		desc_id = "menu_l_global_value_pxp3",
		unlock_id = "bm_global_value_pxp3_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = false,
		hide_unavailable = false,
	...
	self.global_values.pxp4 = {
		name_id = "bm_global_value_pxp4",
		desc_id = "menu_l_global_value_pxp4",
		unlock_id = "bm_global_value_pxp4_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = false,
		hide_unavailable = false,
	...
	self.global_values.txt4 = {
		name_id = "bm_global_value_txt4",
		desc_id = "menu_l_global_value_txt4",
		unlock_id = "bm_global_value_txt4_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = false,
		hide_unavailable = false,
	...
	self.global_values.unk = {
		name_id = "bm_global_value_unk",
		desc_id = "menu_l_global_value_unk",
		unlock_id = "bm_global_value_unk_unlock",
		color = tweak_data.screen_colors.dlc_color,
		dlc = true,
		free = true,
		hide_unavailable = false,
