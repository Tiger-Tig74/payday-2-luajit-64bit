...
function PlayerTweakData:_init_new_stances()
	...
	self:_init_hk51b()
	self:_init_tkb()
	self:_init_contender()
	self:_init_hcar()
	self:_init_awp()
	self:_init_supernova()
	self:_init_kacchainsaw()
	self:_init_m249()
	self:_init_rpk()
	self:_init_m95()
	self:_init_msr()
...
function PlayerTweakData:_init_tkb()
	self.stances.tkb = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.545, 11.3934, -3.33201)
	local pivot_shoulder_rotation = Rotation(4.78916e-05, 0.00548037, -0.00110991)
	local pivot_head_translation = Vector3(8, 10, -2)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.tkb.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.tkb.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.tkb.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.tkb.standard.vel_overshot.yaw_neg = 15
	self.stances.tkb.standard.vel_overshot.yaw_pos = -15
	self.stances.tkb.standard.vel_overshot.pitch_neg = -15
	self.stances.tkb.standard.vel_overshot.pitch_pos = 15
	local pivot_head_translation = Vector3(1.95, 10, -1.45)
	local pivot_head_rotation = Rotation(0.1, 0.5, 10)
	self.stances.tkb.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.tkb.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.tkb.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -18, 0)
	self.stances.tkb.steelsight.vel_overshot.yaw_neg = 10
	self.stances.tkb.steelsight.vel_overshot.yaw_pos = -10
	self.stances.tkb.steelsight.vel_overshot.pitch_neg = -10
	self.stances.tkb.steelsight.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(7, 12, -5)
	local pivot_head_rotation = Rotation(0, 0, -5)
	self.stances.tkb.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.tkb.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.tkb.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_contender()
	self.stances.contender = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(12.2416, 46.6844, -6.3)
	local pivot_shoulder_rotation = Rotation(-0.208124, -0.173875, 0.0680379)
	local pivot_head_translation = Vector3(11, 45, -3.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.contender.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.contender.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.contender.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	local pivot_head_translation = Vector3(0, 40, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.contender.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.contender.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.contender.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
	self.stances.contender.steelsight.vel_overshot.yaw_neg = 2
	self.stances.contender.steelsight.vel_overshot.yaw_pos = -2
	self.stances.contender.steelsight.vel_overshot.pitch_neg = -2
	self.stances.contender.steelsight.vel_overshot.pitch_pos = 2
	local pivot_head_translation = Vector3(10, 44, -4.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.contender.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.contender.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.contender.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_hcar()
	self.stances.hcar = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.545, 11.3934, -3.33201)
	local pivot_shoulder_rotation = Rotation(4.78916e-05, 0.00548037, -0.00110991)
	local pivot_head_translation = Vector3(8, 10, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.hcar.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hcar.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hcar.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.hcar.standard.vel_overshot.yaw_neg = 10
	self.stances.hcar.standard.vel_overshot.yaw_pos = -10
	self.stances.hcar.standard.vel_overshot.pitch_neg = -10
	self.stances.hcar.standard.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(1.95, 10, -1.45)
	local pivot_head_rotation = Rotation(0.1, 0.5, 10)
	self.stances.hcar.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hcar.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hcar.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -3, 0)
	self.stances.hcar.steelsight.vel_overshot.yaw_neg = 5
	self.stances.hcar.steelsight.vel_overshot.yaw_pos = -5
	self.stances.hcar.steelsight.vel_overshot.pitch_neg = -5
	self.stances.hcar.steelsight.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(7, 5, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.hcar.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hcar.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hcar.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_hk51b()
	self.stances.hk51b = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.545, 11.3934, -3.33201)
	local pivot_shoulder_rotation = Rotation(4.78916e-05, 0.00548037, -0.00110991)
	local pivot_head_translation = Vector3(6, 12, -5)
	local pivot_head_rotation = Rotation(0.4, 0.8, -2)
	self.stances.hk51b.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hk51b.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hk51b.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -5, 0)
	self.stances.hk51b.standard.vel_overshot.yaw_neg = 15
	self.stances.hk51b.standard.vel_overshot.yaw_pos = -15
	self.stances.hk51b.standard.vel_overshot.pitch_neg = -15
	self.stances.hk51b.standard.vel_overshot.pitch_pos = 15
	local pivot_head_translation = Vector3(-2.2, 7, -0.32)
	local pivot_head_rotation = Rotation(-0.1, 1, 0)
	...
	self.stances.hk51b.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -5, 0)
	self.stances.hk51b.steelsight.vel_overshot.yaw_neg = 5
	self.stances.hk51b.steelsight.vel_overshot.yaw_pos = -5
	self.stances.hk51b.steelsight.vel_overshot.pitch_neg = -5
	self.stances.hk51b.steelsight.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(7, 8, -5)
	local pivot_head_rotation = Rotation(0.4, 0.8, -2)
	self.stances.hk51b.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hk51b.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hk51b.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.hk51b.bipod = {
		shoulders = {},
		vel_overshot = {}
	}
	local pivot_head_translation = Vector3(0, 0, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.hk51b.bipod.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hk51b.bipod.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hk51b.bipod.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -0, 0)
	self.stances.hk51b.bipod.vel_overshot.yaw_neg = 0
	self.stances.hk51b.bipod.vel_overshot.yaw_pos = 0
	self.stances.hk51b.bipod.vel_overshot.pitch_neg = 0
	self.stances.hk51b.bipod.vel_overshot.pitch_pos = 0
	self.stances.hk51b.bipod.FOV = 50
	self.stances.hk51b.bipod.shakers = {
		breathing = {}
	}
	self.stances.hk51b.bipod.shakers.breathing.amplitude = 0
end
...
function PlayerTweakData:_init_awp()
	self.stances.awp = deep_clone(self.stances.default)
	...
	local pivot_head_translation = Vector3(7.5, 37, -2)
	local pivot_head_rotation = Rotation(0, 0, -1)
	self.stances.awp.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.awp.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.awp.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -50, 0)
	self.stances.awp.standard.vel_overshot.yaw_neg = 15
	self.stances.awp.standard.vel_overshot.yaw_pos = -15
	self.stances.awp.standard.vel_overshot.pitch_neg = -15
	self.stances.awp.standard.vel_overshot.pitch_pos = 15
	local pivot_head_translation = Vector3(-1.55, 3, -2.25)
	...
	self.stances.awp.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -50, 0)
	self.stances.awp.steelsight.vel_overshot.yaw_neg = 1
	self.stances.awp.steelsight.vel_overshot.yaw_pos = -1
	self.stances.awp.steelsight.vel_overshot.pitch_neg = -1
	self.stances.awp.steelsight.vel_overshot.pitch_pos = 1
	local pivot_head_translation = Vector3(8, 30, -4.75)
	local pivot_head_rotation = Rotation(0, 0, -5)
	self.stances.awp.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.awp.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.awp.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_supernova()
	self.stances.supernova = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(7.5, 16.5, -3.5)
	local pivot_shoulder_rotation = Rotation(0, 0, 0)
	local pivot_head_translation = Vector3(7, 20, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.supernova.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.supernova.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.supernova.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.supernova.standard.vel_overshot.yaw_neg = 15
	self.stances.supernova.standard.vel_overshot.yaw_pos = -5
	self.stances.supernova.standard.vel_overshot.pitch_neg = -10
	self.stances.supernova.standard.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(-0.85, 17, 1.1)
	local pivot_head_rotation = Rotation(-0.37, 0.1, -1)
	...
	self.stances.supernova.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.supernova.steelsight.vel_overshot.yaw_neg = 3
	self.stances.supernova.steelsight.vel_overshot.yaw_pos = -3
	self.stances.supernova.steelsight.vel_overshot.pitch_neg = -10
	self.stances.supernova.steelsight.vel_overshot.pitch_pos = 2
	local pivot_head_translation = Vector3(6.5, 21, -7)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.supernova.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.supernova.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.supernova.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end
...
function PlayerTweakData:_init_kacchainsaw()
	...
	self.stances.kacchainsaw.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.kacchainsaw.standard.vel_overshot.yaw_neg = 15
	self.stances.kacchainsaw.standard.vel_overshot.yaw_pos = -15
	self.stances.kacchainsaw.standard.vel_overshot.pitch_neg = -15
	self.stances.kacchainsaw.standard.vel_overshot.pitch_pos = 15
	...
	self.stances.kacchainsaw.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -18, 0)
	self.stances.kacchainsaw.steelsight.vel_overshot.yaw_neg = 10
	self.stances.kacchainsaw.steelsight.vel_overshot.yaw_pos = -10
	...
	local pivot_head_rotation = Rotation(0.10661, 2.35, -3.6285)
	...
	self.stances.kacchainsaw.bipod = {
		shoulders = {},
		vel_overshot = {}
	}
	local pivot_head_translation = Vector3(0, 6, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.kacchainsaw.bipod.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.kacchainsaw.bipod.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.kacchainsaw.bipod.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, 0, 0)
	self.stances.kacchainsaw.bipod.vel_overshot.yaw_neg = 0
	self.stances.kacchainsaw.bipod.vel_overshot.yaw_pos = 0
	self.stances.kacchainsaw.bipod.vel_overshot.pitch_neg = 0
	self.stances.kacchainsaw.bipod.vel_overshot.pitch_pos = 0
	self.stances.kacchainsaw.bipod.FOV = 50
	self.stances.kacchainsaw.bipod.shakers = {
		breathing = {}
	}
	self.stances.kacchainsaw.bipod.shakers.breathing.amplitude = 0
end
...
function PlayerTweakData:_init_scout()
	...
	self.stances.scout.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -24, 0)
	self.stances.scout.standard.vel_overshot.yaw_neg = 12
	...
	self.stances.scout.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -15, 0)
	self.stances.scout.steelsight.vel_overshot.yaw_neg = 2
	self.stances.scout.steelsight.vel_overshot.yaw_pos = -2
	self.stances.scout.steelsight.vel_overshot.pitch_neg = -2
	self.stances.scout.steelsight.vel_overshot.pitch_pos = 2
	local pivot_head_translation = Vector3(9, 41, -6)
	local pivot_head_rotation = Rotation(0.6, 0.7, 0)
	self.stances.scout.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.scout.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.scout.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end
...
function PlayerTweakData:_init_qbu88()
	self.stances.qbu88 = deep_clone(self.stances.default)
	...
	local pivot_head_rotation = Rotation(0, 0, 1)
	self.stances.qbu88.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.qbu88.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.qbu88.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -22, 0)
	self.stances.qbu88.standard.vel_overshot.yaw_neg = 5
	self.stances.qbu88.standard.vel_overshot.yaw_pos = -5
	self.stances.qbu88.standard.vel_overshot.pitch_neg = -5
	self.stances.qbu88.standard.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(0, 24, -1)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.qbu88.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.qbu88.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.qbu88.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -25, 0)
	self.stances.qbu88.steelsight.vel_overshot.yaw_neg = -2
	self.stances.qbu88.steelsight.vel_overshot.yaw_pos = 2
	self.stances.qbu88.steelsight.vel_overshot.pitch_neg = 1
	self.stances.qbu88.steelsight.vel_overshot.pitch_pos = -1
	local pivot_head_translation = Vector3(9, 19, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.qbu88.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.qbu88.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.qbu88.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -22, 0)
	self.stances.qbu88.crouched.vel_overshot.yaw_neg = -3
	self.stances.qbu88.crouched.vel_overshot.yaw_pos = 3
	self.stances.qbu88.crouched.vel_overshot.pitch_neg = 2
	self.stances.qbu88.crouched.vel_overshot.pitch_pos = -2
end

function PlayerTweakData:_init_groza()
	self.stances.groza = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(13.2306, 18.767, -1.72531)
	local pivot_shoulder_rotation = Rotation(-1.26267, 0.777322, 0.38795)
	local pivot_head_translation = Vector3(10, 20, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.groza.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.groza.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.groza.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -22, 0)
	self.stances.groza.standard.vel_overshot.yaw_neg = 5
	self.stances.groza.standard.vel_overshot.yaw_pos = -5
	self.stances.groza.standard.vel_overshot.pitch_neg = -5
	self.stances.groza.standard.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(0, 24, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.groza.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.groza.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.groza.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -25, 0)
	self.stances.groza.steelsight.vel_overshot.yaw_neg = -2
	self.stances.groza.steelsight.vel_overshot.yaw_pos = 2
	self.stances.groza.steelsight.vel_overshot.pitch_neg = 1
	self.stances.groza.steelsight.vel_overshot.pitch_pos = -1
	local pivot_head_translation = Vector3(9, 19, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.groza.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.groza.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.groza.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -22, 0)
	self.stances.groza.crouched.vel_overshot.yaw_neg = -3
	self.stances.groza.crouched.vel_overshot.yaw_pos = 3
	self.stances.groza.crouched.vel_overshot.pitch_neg = 2
	self.stances.groza.crouched.vel_overshot.pitch_pos = -2
end
...
function PlayerTweakData:_init_pm9()
	...
	self.stances.pm9.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.pm9.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -40, 0)
	self.stances.pm9.standard.vel_overshot.yaw_neg = 9
	...
	self.stances.pm9.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.pm9.steelsight.vel_overshot.yaw_neg = 15
	self.stances.pm9.steelsight.vel_overshot.yaw_pos = -15
	self.stances.pm9.steelsight.vel_overshot.pitch_neg = -15
	self.stances.pm9.steelsight.vel_overshot.pitch_pos = 15
	local pivot_head_translation = Vector3(6, 15, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.pm9.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.pm9.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.pm9.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -40, 0)
end

function PlayerTweakData:_init_x_pm9()
	self.stances.x_pm9 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.95, 28, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_pm9.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_pm9.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_pm9.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.95, 32, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_pm9.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_pm9.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_pm9.steelsight.zoom_fov = false
	self.stances.x_pm9.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_pm9.steelsight.vel_overshot.yaw_neg = 5
	self.stances.x_pm9.steelsight.vel_overshot.yaw_pos = -5
	self.stances.x_pm9.steelsight.vel_overshot.pitch_neg = -12
	self.stances.x_pm9.steelsight.vel_overshot.pitch_pos = 12
	local pivot_head_translation = Vector3(10.95, 28, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_pm9.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_pm9.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_pm9.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_shak12()
	self.stances.shak12 = deep_clone(self.stances.default)
	...
	local pivot_head_rotation = Rotation(0, 0, 1)
	self.stances.shak12.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.shak12.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.shak12.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -22, 0)
	self.stances.shak12.standard.vel_overshot.yaw_neg = 5
	self.stances.shak12.standard.vel_overshot.yaw_pos = -5
	self.stances.shak12.standard.vel_overshot.pitch_neg = -5
	self.stances.shak12.standard.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(0, 22, -2.65)
	local pivot_head_rotation = Rotation(0, 0.5, 0)
	self.stances.shak12.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.shak12.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.shak12.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -25, 0)
	self.stances.shak12.steelsight.vel_overshot.yaw_neg = -2
	self.stances.shak12.steelsight.vel_overshot.yaw_pos = 2
	self.stances.shak12.steelsight.vel_overshot.pitch_neg = 1
	self.stances.shak12.steelsight.vel_overshot.pitch_pos = -1
	local pivot_head_translation = Vector3(9, 19, -4)
	local pivot_head_rotation = Rotation(0.2, 0, -0.1)
	self.stances.shak12.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.shak12.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.shak12.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -22, 0)
	self.stances.shak12.crouched.vel_overshot.yaw_neg = -3
	self.stances.shak12.crouched.vel_overshot.yaw_pos = 3
	self.stances.shak12.crouched.vel_overshot.pitch_neg = 2
	self.stances.shak12.crouched.vel_overshot.pitch_pos = -2
end

function PlayerTweakData:_init_m1911()
	self.stances.m1911 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.44347, 40.2309, -5.37017)
	local pivot_shoulder_rotation = Rotation(0.100314, -0.688477, 0.629269)
	local pivot_head_translation = Vector3(8, 32, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	...
	self.stances.m1911.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	local pivot_head_translation = Vector3(0, 30, -1.4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	...
	self.stances.m1911.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.m1911.steelsight.vel_overshot.yaw_neg = 5
	self.stances.m1911.steelsight.vel_overshot.yaw_pos = -5
	self.stances.m1911.steelsight.vel_overshot.pitch_neg = -12
	self.stances.m1911.steelsight.vel_overshot.pitch_pos = 12
	local pivot_head_translation = Vector3(5.5, 31, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	...
	self.stances.m1911.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_x_m1911()
	self.stances.x_m1911 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.5, 39, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_m1911.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_m1911.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_m1911.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.5, 46, -1)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_m1911.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_m1911.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_m1911.steelsight.zoom_fov = false
	self.stances.x_m1911.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_m1911.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_m1911.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_m1911.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_m1911.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.5, 37, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_m1911.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_m1911.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_m1911.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_vityaz()
	self.stances.vityaz = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.6777, 19.971, -3.11304)
	local pivot_shoulder_rotation = Rotation(0.10658, -0.0846555, 0.628465)
	local pivot_head_translation = Vector3(9.5, 18, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.vityaz.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.vityaz.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.vityaz.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
	self.stances.vityaz.standard.vel_overshot.yaw_neg = 10
	self.stances.vityaz.standard.vel_overshot.yaw_pos = -10
	self.stances.vityaz.standard.vel_overshot.pitch_neg = -10
	self.stances.vityaz.standard.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(-0.017, 15, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	...
	self.stances.vityaz.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.vityaz.steelsight.vel_overshot.yaw_neg = 4
	self.stances.vityaz.steelsight.vel_overshot.yaw_pos = -4
	self.stances.vityaz.steelsight.vel_overshot.pitch_neg = -17
	self.stances.vityaz.steelsight.vel_overshot.pitch_pos = 17
	local pivot_head_translation = Vector3(7, 10, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.vityaz.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.vityaz.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.vityaz.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_x_vityaz()
	self.stances.x_vityaz = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.95, 39, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_vityaz.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_vityaz.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_vityaz.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.95, 46, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_vityaz.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_vityaz.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_vityaz.steelsight.zoom_fov = false
	self.stances.x_vityaz.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_vityaz.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_vityaz.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_vityaz.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_vityaz.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.95, 37, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_vityaz.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_vityaz.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_vityaz.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_m590()
	self.stances.m590 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.6371, 13.6152, -4.94151)
	local pivot_shoulder_rotation = Rotation(0.106574, -0.0863493, 0.62765)
	local pivot_head_translation = Vector3(7, 20, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.m590.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.m590.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.m590.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.m590.standard.vel_overshot.yaw_neg = 15
	self.stances.m590.standard.vel_overshot.yaw_pos = -5
	self.stances.m590.standard.vel_overshot.pitch_neg = -10
	self.stances.m590.standard.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(0, 15, 0.5)
	local pivot_head_rotation = Rotation(0, 0.5, 0)
	self.stances.m590.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.m590.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.m590.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.m590.steelsight.vel_overshot.yaw_neg = 3
	self.stances.m590.steelsight.vel_overshot.yaw_pos = -3
	self.stances.m590.steelsight.vel_overshot.pitch_neg = -10
	self.stances.m590.steelsight.vel_overshot.pitch_pos = 2
	local pivot_head_translation = Vector3(6.5, 21, -7)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.m590.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.m590.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.m590.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end
...
function PlayerTweakData:_init_ms3gl()
	self.stances.ms3gl = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(12.6007, 11.9289, 1.92507)
	local pivot_shoulder_rotation = Rotation(7.38981e-05, -0.000869142, -0.0013114)
	local pivot_head_translation = Vector3(10, 18, 1.5)
	local pivot_head_rotation = Rotation(0.7, 0.8, 0)
	self.stances.ms3gl.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.ms3gl.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.ms3gl.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.ms3gl.standard.vel_overshot.yaw_neg = 15
	self.stances.ms3gl.standard.vel_overshot.yaw_pos = -15
	self.stances.ms3gl.standard.vel_overshot.pitch_neg = -15
	self.stances.ms3gl.standard.vel_overshot.pitch_pos = 15
	local pivot_head_translation = Vector3(0, 17, 1.9)
	local pivot_head_rotation = Rotation(0, 6, 0)
	self.stances.ms3gl.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.ms3gl.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.ms3gl.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -50, 0)
	self.stances.ms3gl.steelsight.vel_overshot.yaw_neg = 0
	self.stances.ms3gl.steelsight.vel_overshot.yaw_pos = -0
	self.stances.ms3gl.steelsight.vel_overshot.pitch_neg = -0
	self.stances.ms3gl.steelsight.vel_overshot.pitch_pos = 0
	local pivot_head_translation = Vector3(10, 19, -1.5)
	local pivot_head_rotation = Rotation(0.7, 0.8, 0)
	self.stances.ms3gl.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.ms3gl.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.ms3gl.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end
...
function PlayerTweakData:_init_victor()
	self.stances.victor = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(9.36916, 15.8528, -0.934953)
	local pivot_shoulder_rotation = Rotation(-0.000713286, 0.00034839, -5.86914e-05)
	local pivot_head_translation = Vector3(8.5, 17, -1)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.victor.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.victor.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.victor.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.victor.standard.vel_overshot.yaw_neg = -6
	self.stances.victor.standard.vel_overshot.yaw_pos = 6
	self.stances.victor.standard.vel_overshot.pitch_neg = 10
	self.stances.victor.standard.vel_overshot.pitch_pos = -10
	local pivot_head_translation = Vector3(0, 14, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.victor.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.victor.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.victor.steelsight.zoom_fov = false
	self.stances.victor.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -50, 0)
	self.stances.victor.steelsight.vel_overshot.yaw_neg = -0.5
	self.stances.victor.steelsight.vel_overshot.yaw_pos = 0.5
	self.stances.victor.steelsight.vel_overshot.pitch_neg = 1.5
	self.stances.victor.steelsight.vel_overshot.pitch_pos = -1.5
	local pivot_head_translation = Vector3(7.5, 16, -2)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.victor.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.victor.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.victor.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.victor.crouched.vel_overshot.yaw_neg = -4
	self.stances.victor.crouched.vel_overshot.yaw_pos = 4
	self.stances.victor.crouched.vel_overshot.pitch_neg = 8
	self.stances.victor.crouched.vel_overshot.pitch_pos = -8
end
...
function PlayerTweakData:_init_type54()
	self.stances.type54 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.44788, 38.6251, -5.22182)
	local pivot_shoulder_rotation = Rotation(0.100018, -0.688258, 0.629664)
	local pivot_head_translation = Vector3(10, 32, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.type54.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.type54.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.type54.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
	self.stances.type54.steelsight.vel_overshot.pitch_neg = -17
	self.stances.type54.steelsight.vel_overshot.pitch_pos = 17
	local pivot_head_translation = Vector3(0, 29, 0.4)
	local pivot_head_rotation = Rotation(0, 1, 0)
	self.stances.type54.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.type54.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.type54.steelsight.FOV = self.stances.type54.standard.FOV
	self.stances.type54.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -7, 0)
	self.stances.type54.steelsight.vel_overshot.yaw_neg = 1
	self.stances.type54.steelsight.vel_overshot.yaw_pos = -1
	self.stances.type54.steelsight.vel_overshot.pitch_neg = -5
	self.stances.type54.steelsight.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(9, 31, -6)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.type54.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.type54.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.type54.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
end

function PlayerTweakData:_init_x_type54()
	self.stances.x_type54 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.5, 39, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_type54.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_type54.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_type54.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.5, 46, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_type54.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_type54.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_type54.steelsight.zoom_fov = false
	self.stances.x_type54.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_type54.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_type54.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_type54.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_type54.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.5, 37, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_type54.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_type54.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_type54.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_rsh12()
	self.stances.rsh12 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.51217, 43.8759, -2.44869)
	local pivot_shoulder_rotation = Rotation(0.0994018, -0.689525, 0.618385)
	local pivot_head_translation = Vector3(8, 31, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.rsh12.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.rsh12.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.rsh12.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.rsh12.standard.vel_overshot.yaw_neg = -5
	self.stances.rsh12.standard.vel_overshot.yaw_pos = 2
	self.stances.rsh12.standard.vel_overshot.pitch_neg = 5
	self.stances.rsh12.standard.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(0, 36, -1)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.rsh12.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.rsh12.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.rsh12.steelsight.zoom_fov = false
	self.stances.rsh12.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -35, 0)
	self.stances.rsh12.steelsight.vel_overshot.yaw_neg = -5
	self.stances.rsh12.steelsight.vel_overshot.yaw_pos = 2
	self.stances.rsh12.steelsight.vel_overshot.pitch_neg = 5
	self.stances.rsh12.steelsight.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(7, 30, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.rsh12.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.rsh12.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.rsh12.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end
...
function PlayerTweakData:_init_hailstorm()
	self.stances.hailstorm = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10, 18, 2)
	local pivot_shoulder_rotation = Rotation(0.2128, 0.969032, 0.196812)
	local pivot_head_translation = Vector3(8, 20, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.hailstorm.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hailstorm.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hailstorm.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -25, 0)
	self.stances.hailstorm.standard.vel_overshot.yaw_neg = 10
	self.stances.hailstorm.standard.vel_overshot.yaw_pos = -10
	self.stances.hailstorm.standard.vel_overshot.pitch_neg = -15
	self.stances.hailstorm.standard.vel_overshot.pitch_pos = 15
	local pivot_head_translation = Vector3(-0.725, 15, 0.6)
	local pivot_head_rotation = Rotation(-0, -1, 0)
	self.stances.hailstorm.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hailstorm.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hailstorm.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -15, 0)
	self.stances.hailstorm.steelsight.vel_overshot.yaw_neg = 5
	self.stances.hailstorm.steelsight.vel_overshot.yaw_pos = -5
	self.stances.hailstorm.steelsight.vel_overshot.pitch_neg = -17
	self.stances.hailstorm.steelsight.vel_overshot.pitch_pos = 17
	local pivot_head_translation = Vector3(10, 21, -2.25)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.hailstorm.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.hailstorm.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.hailstorm.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -25, 0)
end

function PlayerTweakData:_init_korth()
	self.stances.korth = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.43999, 43.8644, -2.22393)
	local pivot_shoulder_rotation = Rotation(0.100024, -0.688276, 0.608057)
	local pivot_head_translation = Vector3(8, 33, -3.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.korth.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.korth.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.korth.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.korth.standard.vel_overshot.yaw_neg = -5
	self.stances.korth.standard.vel_overshot.yaw_pos = 2
	self.stances.korth.standard.vel_overshot.pitch_neg = 5
	self.stances.korth.standard.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(-0.05, 36, 0.2)
	local pivot_head_rotation = Rotation(0.075, -0, 0)
	self.stances.korth.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.korth.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.korth.steelsight.zoom_fov = false
	self.stances.korth.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -35, 0)
	self.stances.korth.steelsight.vel_overshot.yaw_neg = -5
	self.stances.korth.steelsight.vel_overshot.yaw_pos = 2
	self.stances.korth.steelsight.vel_overshot.pitch_neg = 5
	self.stances.korth.steelsight.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(7, 32, -4.5)
	local pivot_head_rotation = Rotation(0, 0, -2.5)
	self.stances.korth.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.korth.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.korth.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_x_korth()
	self.stances.x_korth = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.4, 34, -7)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_korth.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_korth.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_korth.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.4, 46, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_korth.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_korth.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_korth.steelsight.zoom_fov = false
	self.stances.x_korth.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_korth.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_korth.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_korth.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_korth.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.4, 33, -6)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_korth.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_korth.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_korth.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_sko12()
	self.stances.sko12 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.6889, 8.35995, -1.93982)
	local pivot_shoulder_rotation = Rotation(0.106667, -0.0849741, 0.628589)
	local pivot_head_translation = Vector3(10.6889, 12.5, -1.93982)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.sko12.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.sko12.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.sko12.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.sko12.standard.vel_overshot.yaw_neg = -5
	self.stances.sko12.standard.vel_overshot.yaw_pos = 2
	self.stances.sko12.standard.vel_overshot.pitch_neg = 5
	self.stances.sko12.standard.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(0, 15, -0.2)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.sko12.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.sko12.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.sko12.steelsight.zoom_fov = false
	self.stances.sko12.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -35, 0)
	self.stances.sko12.steelsight.vel_overshot.yaw_neg = -5
	self.stances.sko12.steelsight.vel_overshot.yaw_pos = 2
	self.stances.sko12.steelsight.vel_overshot.pitch_neg = 5
	self.stances.sko12.steelsight.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(9.6889, 8, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.sko12.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.sko12.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.sko12.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_x_sko12()
	self.stances.x_sko12 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.5, 39, -7)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_sko12.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_sko12.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_sko12.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.5, 56, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_sko12.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_sko12.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_sko12.steelsight.zoom_fov = false
	self.stances.x_sko12.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_sko12.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_sko12.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_sko12.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_sko12.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.5, 37, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_sko12.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_sko12.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_sko12.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end
...
function PlayerTweakData:_init_maxim9()
	self.stances.maxim9 = deep_clone(self.stances.default)
	...
	local pivot_head_translation = Vector3(7.5, 24, -4)
	local pivot_head_rotation = Rotation(0, 1.5, -3)
	self.stances.maxim9.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.maxim9.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.maxim9.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
	self.stances.maxim9.steelsight.vel_overshot.pitch_neg = -17
	self.stances.maxim9.steelsight.vel_overshot.pitch_pos = 17
	local pivot_head_translation = Vector3(-0.05, 25, -0.8)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.maxim9.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.maxim9.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.maxim9.steelsight.FOV = self.stances.lemming.standard.FOV
	self.stances.maxim9.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -7, 0)
	self.stances.maxim9.steelsight.vel_overshot.yaw_neg = 1
	self.stances.maxim9.steelsight.vel_overshot.yaw_pos = -1
	self.stances.maxim9.steelsight.vel_overshot.pitch_neg = -5
	self.stances.maxim9.steelsight.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(5, 21, -6)
	local pivot_head_rotation = Rotation(-0, 0, -3)
	self.stances.maxim9.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.maxim9.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.maxim9.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
end

function PlayerTweakData:_init_x_maxim9()
	self.stances.x_maxim9 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.95, 27, -3.5)
	local pivot_head_rotation = Rotation(0, 1, 0)
	self.stances.x_maxim9.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_maxim9.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_maxim9.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.95, 35, -3)
	local pivot_head_rotation = Rotation(0, 0.5, 0)
	self.stances.x_maxim9.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_maxim9.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_maxim9.steelsight.zoom_fov = false
	self.stances.x_maxim9.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_maxim9.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_maxim9.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_maxim9.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_maxim9.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.95, 30, -3)
	local pivot_head_rotation = Rotation(0, 0.5, 0)
	self.stances.x_maxim9.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_maxim9.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_maxim9.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_ultima()
	self.stances.ultima = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(9.27651, 19.3937, -6.03765)
	local pivot_shoulder_rotation = Rotation(4.57709e-05, 0.00055666, -0.000335693)
	local pivot_head_translation = Vector3(7.5, 22, -6)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.ultima.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.ultima.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.ultima.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.ultima.standard.vel_overshot.yaw_neg = 15
	self.stances.ultima.standard.vel_overshot.yaw_pos = -5
	self.stances.ultima.standard.vel_overshot.pitch_neg = -10
	self.stances.ultima.standard.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(0, 25, -2.5)
	local pivot_head_rotation = Rotation(0, 0.5, 0)
	self.stances.ultima.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.ultima.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.ultima.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.ultima.steelsight.vel_overshot.yaw_neg = 3
	self.stances.ultima.steelsight.vel_overshot.yaw_pos = -3
	self.stances.ultima.steelsight.vel_overshot.pitch_neg = -10
	self.stances.ultima.steelsight.vel_overshot.pitch_pos = 2
	local pivot_head_translation = Vector3(6.5, 21, -7)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.ultima.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.ultima.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.ultima.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
end

function PlayerTweakData:_init_fmg9()
	self.stances.fmg9 = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.6394, 18.2098, -7.33357)
	local pivot_shoulder_rotation = Rotation(0.106663, -0.0849746, 0.628575)
	local pivot_head_translation = Vector3(8, 22, -5.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.fmg9.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.fmg9.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.fmg9.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -15, 0)
	self.stances.fmg9.standard.vel_overshot.yaw_neg = 10
	self.stances.fmg9.standard.vel_overshot.yaw_pos = -10
	self.stances.fmg9.standard.vel_overshot.pitch_neg = -5
	self.stances.fmg9.standard.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(-1, 25, -5.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.fmg9.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.fmg9.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.fmg9.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -30, 0)
	self.stances.fmg9.steelsight.vel_overshot.yaw_neg = 4
	self.stances.fmg9.steelsight.vel_overshot.yaw_pos = -4
	self.stances.fmg9.steelsight.vel_overshot.pitch_neg = -8
	self.stances.fmg9.steelsight.vel_overshot.pitch_pos = 8
	local pivot_head_translation = Vector3(7, 20, -6.5)
	local pivot_head_rotation = Rotation(0, 0, -8)
	self.stances.fmg9.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.fmg9.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.fmg9.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -15, 0)
end
...
function PlayerTweakData:_init_pmm()
	self.stances.pmm = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.44539, 43.3056, -4.70979)
	local pivot_shoulder_rotation = Rotation(0.100026, -0.68821, 0.629665)
	local pivot_head_translation = Vector3(6.5, 32, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.pmm.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.pmm.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.pmm.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	local pivot_head_translation = Vector3(0, 37, 0)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.pmm.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.pmm.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.pmm.steelsight.zoom_fov = false
	self.stances.pmm.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.pmm.steelsight.vel_overshot.yaw_neg = 5
	self.stances.pmm.steelsight.vel_overshot.yaw_pos = -5
	self.stances.pmm.steelsight.vel_overshot.pitch_neg = -12
	self.stances.pmm.steelsight.vel_overshot.pitch_pos = 12
	local pivot_head_translation = Vector3(5.5, 31, -4)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.pmm.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.pmm.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.pmm.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_pmm = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.9257, 47.3309, -0.659333)
	local pivot_shoulder_rotation = Rotation(-7.3371e-08, -8.32429e-06, -1.70755e-06)
	local pivot_head_translation = Vector3(10.5, 39, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_pmm.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_pmm.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_pmm.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -86, 0)
	local pivot_head_translation = Vector3(10.5, 46, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_pmm.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_pmm.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_pmm.steelsight.zoom_fov = false
	self.stances.x_pmm.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
	self.stances.x_pmm.steelsight.vel_overshot.yaw_neg = -5
	self.stances.x_pmm.steelsight.vel_overshot.yaw_pos = 5
	self.stances.x_pmm.steelsight.vel_overshot.pitch_neg = 12
	self.stances.x_pmm.steelsight.vel_overshot.pitch_pos = -12
	local pivot_head_translation = Vector3(10.5, 37, -3)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.x_pmm.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.x_pmm.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.x_pmm.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -36, 0)
end

function PlayerTweakData:_init_speen()
	self.stances.speen = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.603, 9.54151, -3.18)
	local pivot_shoulder_rotation = Rotation(5.55797e-05, 0.000568586, -0.000334093)
	local pivot_head_translation = Vector3(11, 18, -5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.speen.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.speen.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.speen.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
	self.stances.speen.steelsight.vel_overshot.pitch_neg = -17
	self.stances.speen.steelsight.vel_overshot.pitch_pos = 17
	local pivot_head_translation = Vector3(0, 14, -0.12)
	local pivot_head_rotation = Rotation(0.1, 0.3, 0)
	self.stances.speen.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.speen.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.speen.steelsight.FOV = self.stances.speen.standard.FOV
	self.stances.speen.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -7, 0)
	self.stances.speen.steelsight.vel_overshot.yaw_neg = 1
	self.stances.speen.steelsight.vel_overshot.yaw_pos = -1
	self.stances.speen.steelsight.vel_overshot.pitch_neg = -5
	self.stances.speen.steelsight.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(10, 17, -6)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.speen.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.speen.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.speen.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
end

function PlayerTweakData:_init_dart()
	self.stances.dart = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(10.5286, 33.1301, -3.39847)
	local pivot_shoulder_rotation = Rotation(4.53226e-05, 0.000561889, -0.000335053)
	local pivot_head_translation = Vector3(9, 30, -3.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.dart.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.dart.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.dart.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -40, 0)
	self.stances.dart.standard.vel_overshot.yaw_neg = 10
	self.stances.dart.standard.vel_overshot.yaw_pos = -10
	self.stances.dart.standard.vel_overshot.pitch_neg = -10
	self.stances.dart.standard.vel_overshot.pitch_pos = 10
	local pivot_head_translation = Vector3(-0.05, 29, -2.12)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.dart.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.dart.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.dart.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -20, 0)
	self.stances.dart.steelsight.vel_overshot.yaw_neg = 1
	self.stances.dart.steelsight.vel_overshot.yaw_pos = -1
	self.stances.dart.steelsight.vel_overshot.pitch_neg = -5
	self.stances.dart.steelsight.vel_overshot.pitch_pos = 5
	local pivot_head_translation = Vector3(8, 29, -4.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.dart.crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.dart.crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.dart.crouched.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -40, 0)
end

function PlayerTweakData:_init_flun()
	self.stances.flun = deep_clone(self.stances.default)
	local pivot_shoulder_translation = Vector3(8.43999, 43.8644, -2.22393)
	local pivot_shoulder_rotation = Rotation(0.100024, -0.688276, 0.608057)
	local pivot_head_translation = Vector3(8, 33, -2.5)
	local pivot_head_rotation = Rotation(0, 0, 0)
	self.stances.flun.standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.flun.standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.flun.standard.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -10, 0)
	self.stances.flun.standard.vel_overshot.yaw_neg = -5
	self.stances.flun.standard.vel_overshot.yaw_pos = 2
	self.stances.flun.standard.vel_overshot.pitch_neg = 5
	self.stances.flun.standard.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(-0.1, 36, 1.8)
	local pivot_head_rotation = Rotation(0, 3, 0)
	self.stances.flun.steelsight.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	self.stances.flun.steelsight.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	self.stances.flun.steelsight.zoom_fov = false
	self.stances.flun.steelsight.vel_overshot.pivot = pivot_shoulder_translation + Vector3(0, -35, 0)
	self.stances.flun.steelsight.vel_overshot.yaw_neg = -5
	self.stances.flun.steelsight.vel_overshot.yaw_pos = 2
	self.stances.flun.steelsight.vel_overshot.pitch_neg = 5
	self.stances.flun.steelsight.vel_overshot.pitch_pos = -5
	local pivot_head_translation = Vector3(7, 30, -3.5)
	local pivot_head_rotation = Rotation(0, 1.6, -2)
