...
function HUDManager:init_finalize()
	...
	if not self:exists(IngameAccessCamera.GUI_SAFERECT) then
		...
		managers.hud:load_hud(IngameAccessCamera.GUI_FULLSCREEN, false, false, false, {}, nil, , , group)
		managers.hud:load_hud(IngameAccessCamera.GUI_SAFERECT, false, false, true, {}, nil, , , group)
	end
