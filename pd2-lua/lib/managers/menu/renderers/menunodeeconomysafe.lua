...
function MenuNodeEconomySafe:_test_start_open_economy_safe(safe_entry)
	...
	managers.network.account:inventory_reward_unlock(safe_entry, nil, , callback(self, self, "_test_safe_result_recieved", MenuNodeEconomySafe.reward_unlock_request_id))
