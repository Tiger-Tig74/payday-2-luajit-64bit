...
function MenuCustomizeWeaponColorInitiator:setup_node(node, node_data)
	...
	managers.blackmarket:view_weapon_with_cosmetics(weapon_color_data.category, weapon_color_data.slot, weapon_color_data.cosmetic_data, nil, , BlackMarketGui.get_crafting_custom_data())
