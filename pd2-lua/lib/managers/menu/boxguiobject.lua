...
function BoxGuiObject:create_sides(panel, config)
	...
	self:_create_side(self._panel, "left", left_side, config.texture, config.one_two_align)
	self:_create_side(self._panel, "right", right_side, config.texture, config.one_two_align)
	self:_create_side(self._panel, "top", top_side, config.texture, config.one_two_align)
	self:_create_side(self._panel, "bottom", bottom_side, config.texture, config.one_two_align)
end

function BoxGuiObject:_create_side(panel, side, type, texture, one_two_align)
