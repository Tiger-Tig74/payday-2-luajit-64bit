...
function CrimeNetSidebarGui:clbk_cg22_event()
	managers.features:cg22_event_explanation()
end

function CrimeNetSidebarGui:clbk_pda10_event()
	managers.features:pda10_event_explanation()
end
