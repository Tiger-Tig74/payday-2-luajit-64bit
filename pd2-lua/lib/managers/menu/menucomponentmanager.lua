...
function MenuComponentManager:create_friends_gui()
	...
	self._friends2_gui = FriendsBoxGui:new(self._ws, "Test", "", nil, , "recent")
...
function MenuComponentManager:create_lobby_profile_gui(peer_id, x, y)
	...
	self._lobby_profile_gui = LobbyProfileBoxGui:new(self._ws, nil, , , {
		h = 160,
		x = x,
		y = y
	}, peer_id)
...
function MenuComponentManager:create_view_character_profile_gui(user, x, y)
	...
	self._view_character_profile_gui = ViewCharacterProfileBoxGui:new(self._ws, nil, , , {
		w = 360,
		x = 837,
		h = 160,
		y = 100
...
function MenuComponentManager:create_debug_strings_gui()
	...
	for i, file_name in ipairs({
		...
		local gui = DebugStringsBoxGui:new(self._ws, "file", "", nil, , "strings/" .. file_name)
