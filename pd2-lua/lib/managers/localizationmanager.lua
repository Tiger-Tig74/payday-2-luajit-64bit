...
function LocalizationManager:_setup_macros()
	...
	self:set_default_macro("BTN_RANGE_EMPTY", btn_range_empty)
	self:set_default_macro("BTN_RANGE_FILLED", btn_range_filled)
	self:set_default_macro("BTN_RANGE_BONUS", btn_range_bonus)
